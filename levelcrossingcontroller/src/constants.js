...
// Real French practice at some double-barrier crossings closes each
// approach's two arms in two stages rather than together: the near arm -
// the side cars actually drive in on - closes first, the far (mirrored)
// arm a short while after - barrierType: 'frenchdouble' only
// (Game.updateBarrier() / protection.js's buildDoubleBarrierGate()). This
// is *on top of* BARRIER_CLOSE_DELAY above, not instead of it: the far
// arm's own wait is BARRIER_CLOSE_DELAY plus this.
